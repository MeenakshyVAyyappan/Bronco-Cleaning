              ...
              <div className="service-single-wrap">
                ...
                {ServiceDetails.benefits && ServiceDetails.benefits.length > 0 && (
                  <div className="my-4 p-4 rounded bg-light border-start border-4 border-success">
                    <h3 className="h4 mb-3" style={{ color: "#1E2B21", fontWeight: "700" }}>
                ...
                <div className="my-4 p-4 rounded bg-light">
                  <h3 className="h5 mb-2" style={{ color: "#1E2B21", fontWeight: "700" }}>
                ...
                {/* CTA BANNER */}
                <div className="p-4 rounded text-white text-center my-4" style={{ backgroundColor: "#1E2B21" }}>
            ...
            <div className="col-lg-4 col-12 order-lg-1">
              ...
              <div className="service-sidebar" style={{ position: "sticky", top: "120px" }}>
                ...
                <div className="service-catagory">
                  <h4 className="px-3 pt-3 mb-2" style={{ color: "#1E2B21", fontWeight: "700" }}>
                ...
                <div className="service-info mt-4">
                  ...
                  <a href="https://wa.me/971541484800" target="_blank" rel="noopener noreferrer" className="btn btn-success w-100 mt-3" style={{ borderRadius: "20px", fontWeight: "600" }}>
