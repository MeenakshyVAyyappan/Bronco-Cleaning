        ...
        <div className="row g-4 mt-2">
          ...
          <div className="col-lg-6 col-md-12">
            <Fade direction="up" duration={1000} triggerOnce>
              <div className="vision-mission-box" style={{ background: '#F1F7EC', padding: '50px', borderRadius: '32px', height: '100%', border: '1px solid #DDE7D6' }}>
                <div className="icon mb-4">
                  <i className="ti-eye" style={{ fontSize: '40px', color: '#43903E' }}></i>
                </div>
                <h3 style={{ fontSize: '28px', fontWeight: '700', marginBottom: '20px', color: '#1E2B21' }}>Our Vision</h3>
                <p style={{ fontSize: '18px', color: '#4A4A4C', lineHeight: '1.6' }}>
          ...
          <div className="col-lg-6 col-md-12">
            <Fade direction="up" duration={1200} triggerOnce>
              <div className="vision-mission-box" style={{ background: '#F1F7EC', padding: '50px', borderRadius: '32px', height: '100%', border: '1px solid #DDE7D6' }}>
                <div className="icon mb-4">
                  <i className="ti-target" style={{ fontSize: '40px', color: '#43903E' }}></i>
                </div>
                <h3 style={{ fontSize: '28px', fontWeight: '700', marginBottom: '20px', color: '#1E2B21' }}>Our Mission</h3>
