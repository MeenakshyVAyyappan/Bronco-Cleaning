        ...
        <div className="row g-4 mt-2">
          ...
          <div className="col-lg-6 col-md-12">
            <Fade direction="up" duration={1000} triggerOnce>
              <div className="vision-mission-box" style={{ background: '#F5F5F5', padding: '50px', borderRadius: '32px', height: '100%', border: '1px solid #EBEBEB' }}>
                <div className="icon mb-4">
                  <i className="ti-eye" style={{ fontSize: '40px', color: '#13B251' }}></i>
                </div>
                <h3 style={{ fontSize: '28px', fontWeight: '700', marginBottom: '20px', color: '#1F1818' }}>Our Vision</h3>
          ...
          <div className="col-lg-6 col-md-12">
            <Fade direction="up" duration={1200} triggerOnce>
              <div className="vision-mission-box" style={{ background: '#F5F5F5', padding: '50px', borderRadius: '32px', height: '100%', border: '1px solid #EBEBEB' }}>
                <div className="icon mb-4">
                  <i className="ti-target" style={{ fontSize: '40px', color: '#13B251' }}></i>
                </div>
                <h3 style={{ fontSize: '28px', fontWeight: '700', marginBottom: '20px', color: '#1F1818' }}>Our Mission</h3>
                <p style={{ fontSize: '18px', color: '#666', lineHeight: '1.6' }}>
